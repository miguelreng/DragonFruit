...
export const headerStyle: IHeaderProperties = {
  ...
  [EHeaderVariant.SECONDARY]: "overflow-y-hidden justify-between bg-surface-1 pt-3 pb-2 z-[15]",
  [EHeaderVariant.TERNARY]: "flex flex-wrap justify-between pt-3 pb-2 gap-2 bg-surface-1 z-[12]",
};
