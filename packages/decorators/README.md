...
{
  "dependencies": {
    "@dragonfruit/decorators": "workspace:*"
  }
}
```
...
```typescript
import { Controller, Get, Post, BaseController } from "@dragonfruit/decorators";
...
```typescript
import { Controller, WebSocket, BaseWebSocketController } from "@dragonfruit/decorators";
