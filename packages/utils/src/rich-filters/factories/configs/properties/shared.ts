...
// plane imports
import type { IProject, IUserLite, TOperatorConfigMap, TSupportedOperators } from "@dragonfruit/types";
import { COMPARISON_OPERATOR, EQUALITY_OPERATOR } from "@dragonfruit/types";
// local imports
