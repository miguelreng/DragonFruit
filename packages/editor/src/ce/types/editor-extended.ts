...
/** DragonFruit: agent webhook + wiki lookup + wiki-link inline ref (see ce/extensions/slash-commands.tsx). */
export type TExtendedEditorCommands = "agent" | "wiki" | "wiki-link";
