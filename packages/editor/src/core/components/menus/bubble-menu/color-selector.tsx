  ...
  return (
    <FloatingMenuRoot
      classNames={{
        ...
        button:
          "flex items-center gap-1 h-full whitespace-nowrap px-3 text-13 font-medium text-tertiary hover:bg-layer-1 active:bg-layer-1 rounded-lg transition-colors",
      }}
      menuButton={
        <>
          <span>Color</span>
          <span
            className={cn("grid size-6 flex-shrink-0 place-items-center rounded-lg border-[0.5px] border-strong", {
    ...
    >
      <section className="mt-1 space-y-2 rounded-lg border-[0.5px] border-strong bg-surface-1 p-2 shadow-raised-200">
