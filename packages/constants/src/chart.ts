...
import type { TChartColorScheme } from "@dragonfruit/types";
import { ChartXAxisProperty } from "@dragonfruit/types";

export const LABEL_CLASSNAME = "uppercase text-tertiary/60 text-13";
export const AXIS_LABEL_CLASSNAME = "uppercase text-tertiary/60 text-13";
