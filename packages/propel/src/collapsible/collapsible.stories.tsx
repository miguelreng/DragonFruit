  ...
  render(args) {
    ...
    return (
      <Collapsible.CollapsibleRoot {...args} isOpen={isOpen} onToggle={toggleOpen} className="w-96">
        <Collapsible.CollapsibleTrigger className="bg-gray-100 hover:bg-gray-200 flex w-full items-center justify-between rounded-lg px-4 py-2">
    ...
    return (
      <div className="space-y-4">
        <div className="flex gap-2">
          <button onClick={() => setIsOpen(true)} className="bg-blue-500 rounded-lg px-4 py-2 text-13 text-on-color">
            Open
          </button>
          <button onClick={() => setIsOpen(false)} className="bg-gray-500 rounded-lg px-4 py-2 text-13 text-on-color">
            Close
          </button>
          <button
            onClick={() => setIsOpen(!isOpen)}
            className="bg-green-500 rounded-lg px-4 py-2 text-13 text-on-color"
          >
            Toggle
          </button>
        </div>
  ...
  render(args) {
    ...
    return (
      <Collapsible.CollapsibleRoot {...args} isOpen={isOpen} onToggle={() => setIsOpen(!isOpen)} className="w-96">
        ...
        <Collapsible.CollapsibleContent className="mt-2">
          <div className="border-gray-200 space-y-2 rounded-lg border p-4">
