...
// plane imports
import type { TBottomSectionConfig, TContentVisibility, TTopSectionConfig } from "@dragonfruit/types";
        ...
        <g>
          ...
          {top.showName && (
            <text
              ...
              textAnchor="start"
              className={cn("text-13 font-light select-none", textClassName || "text-tertiary")}
              fill="currentColor"
            >
