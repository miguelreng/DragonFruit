    ...
    <View style={styles.safe}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.identity}>
          <Avatar name={displayName} size={72} circle imageUrl={user?.avatar_url} />
        ...
        <View style={styles.card}>
          ...
          <Pressable
            ...
            accessibilityLabel="Open the web app"
          >
            {({ pressed }) => (
...
const styles = StyleSheet.create({
  ...
  version: { marginTop: spacing.lg, textAlign: "center", fontSize: font.size.xs, color: colors.faint, fontFamily: "Figtree_400Regular" },
});
