...
export const AttachmentIcon = Solar.Paperclip;
export const AtlasTabIcon = Solar.Stars;
export const AtlasTabActiveIcon = SolarBold.Stars;
...
export const CameraIcon = Solar.Camera;
...
export const CheckIcon = SolarBold.CheckRead;
export const BoldIcon = Solar.TextBold;
export const ItalicIcon = Solar.TextItalic;
export const GalleryIcon = Solar.Gallery;
export const BulletListIcon = Solar.List;
export const NumberedListIcon = Solar.ListDownMinimalistic;
export const ChecklistIcon = Solar.ListCheck;
export const CodeIcon = Solar.Code2;
export const Delete02Icon = Solar.TrashBinMinimalistic;
export const DocsTabIcon = Solar.DocumentText;
export const DocsTabActiveIcon = SolarBold.DocumentText;
export const FigmaIcon = Solar.Palette;
export const File01Icon = Solar.File;
export const File02Icon = Solar.File;
export const FileTextIcon = Solar.FileText;
...
export const LockIcon = Solar.Lock;
export const Logout03Icon = Solar.Logout;
export const Mail01Icon = Solar.Letter;
export const MicrophoneIcon = Solar.Microphone;
export const MicrophoneActiveIcon = SolarBold.Microphone;
...
export const SentFilledIcon = SolarBold.Plain;
...
export const StopIcon = Solar.Stop;
export const StickiesTabIcon = Solar.StickerSquare;
export const StickiesTabActiveIcon = SolarBold.StickerSquare;
export const Task01Icon = Solar.Checklist;
export const TasksTabActiveIcon = SolarBold.Checklist;
export const TasksTabIcon = Solar.Checklist;
export const UserGroupIcon = Solar.UsersGroupRounded;
export const UserIcon = Solar.User;
export const UserActiveIcon = SolarBold.User;
