...
export const getCoreAuthenticationModesMap: (
  ...
  google: {
    key: "google",
    name: "Google",
    description: "Allow members to log in or sign up for Dragon Fruit with their Google accounts.",
  ...
  github: {
    key: "github",
    name: "GitHub",
    description: "Allow members to log in or sign up for Dragon Fruit with their GitHub accounts.",
    icon: (
      <img
  ...
  gitlab: {
    key: "gitlab",
    name: "GitLab",
    description: "Allow members to log in or sign up to Dragon Fruit with their GitLab accounts.",
  ...
  gitea: {
    key: "gitea",
    name: "Gitea",
    description: "Allow members to log in or sign up to Dragon Fruit with their Gitea accounts.",
