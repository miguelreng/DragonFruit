...
export const coreRoutes: RouteConfigEntry[] = [
  ...
  layout("./(all)/project-context-oauth-callback/layout.tsx", [
    route("context-sources/google/callback", "./(all)/project-context-oauth-callback/page.tsx"),
  ]),
  ...
  route("auth/native/start", "./(all)/native-login/start.tsx"),
  ...
  layout("./(all)/layout.tsx", [
    ...
    layout("./(all)/[workspaceSlug]/layout.tsx", [
      ...
      layout("./(all)/[workspaceSlug]/(projects)/layout.tsx", [
        ...
        // Docs (workspace-wide pages list)
        layout("./(all)/[workspaceSlug]/(projects)/docs/layout.tsx", [
