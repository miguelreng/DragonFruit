...
import { usePlatformOS } from "@dragonfruit/hooks";
...
import { Breadcrumbs, BreadcrumbNavigationSearchDropdown, Header } from "@dragonfruit/ui";
        ...
        <Header.LeftItem>
          <div className="flex items-center gap-2">
            ...
            {workItemsCount && workItemsCount > 0 ? (
              <Tooltip
                isMobile={isMobile}
                tooltipContent={`There are ${workItemsCount} ${workItemsCount > 1 ? "tasks" : "task"} in this cycle`}
                position="bottom"
              >
