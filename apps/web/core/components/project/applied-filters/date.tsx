...
import { PROJECT_CREATED_AT_FILTER_OPTIONS } from "@dragonfruit/constants";
...
export const AppliedDateFilters = observer(function AppliedDateFilters(props: Props) {
  ...
  return (
    <>
      {values.map((date) => (
        <div key={date} className="flex items-center gap-1 rounded-lg bg-layer-1 px-1.5 py-1 text-11">
