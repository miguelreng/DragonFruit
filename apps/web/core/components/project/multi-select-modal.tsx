            ...
            {selectedProjectIds.map((projectId) => {
              ...
              return (
                <div
                  ...
                  className="group flex cursor-pointer items-center gap-1.5 rounded-lg bg-surface-2 px-2 py-1"
                  onClick={() => {
              ...
              {filteredProjectIds.map((projectId) => {
                ...
                return (
                  <Combobox.Option
                    ...
                    className={({ active }) =>
                      cn(
                        "flex w-full cursor-pointer items-center justify-between gap-2 truncate rounded-lg p-2 text-secondary transition-colors select-none",
                        {
                          "bg-layer-1": active,
