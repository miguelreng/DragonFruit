...
import { ArrowRight, CalendarDays } from "@/components/icons/lucide-shim";
import { Combobox } from "@headlessui/react";
// plane imports
import { useTranslation } from "@dragonfruit/i18n";
// ui
import type { DateRange, Matcher } from "@dragonfruit/propel/calendar";
...
export const DateRangeDropdown = observer(function DateRangeDropdown(props: Props) {
  ...
  const comboOptions = (
    <Combobox.Options data-prevent-outside-click static>
      <div
        className="z-30 my-1 overflow-hidden rounded-lg border-[0.5px] border-subtle-1 bg-surface-1"
        ref={setPopperElement}
        style={styles.popper}
        {...attributes.popper}
      >
        <Calendar
          className="rounded-lg border border-subtle p-3 text-12"
