...
import { cn } from "@dragonfruit/propel/utils";
import type { SingleOrArray, TFilterValue } from "@dragonfruit/types";
import { hasValidValue } from "@dragonfruit/utils";
...
export function FilterItemContainer(props: FilterItemContainerProps) {
  ...
  return (
    <Tooltip tooltipContent={tooltipContent} position="bottom" disabled={!tooltipContent}>
      <div
        ref={itemRef}
        className={cn("flex h-7 items-stretch overflow-hidden rounded-lg border transition-all duration-200", {
