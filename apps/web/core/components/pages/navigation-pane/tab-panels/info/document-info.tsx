...
// plane imports
import type { TDocumentInfo } from "@dragonfruit/editor";
import { useTranslation } from "@dragonfruit/i18n";
import { getReadTimeFromWordsCount } from "@dragonfruit/utils";
// store
  ...
  return (
    <div className="grid grid-cols-2 gap-2">
      {documentInfoCards.map((card) => (
        <div key={card.key} className="rounded-lg bg-layer-2 p-2">
