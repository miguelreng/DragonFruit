...
import { renderFormattedDate, renderFormattedTime } from "@dragonfruit/utils";
// helpers
        ...
        <>
          <div className="flex min-h-14 items-center justify-between gap-2 border-b border-subtle px-5 py-3">
            <div className="flex items-center gap-4">
              ...
              <span className="flex flex-shrink-0 items-center gap-1 rounded-lg bg-accent-primary/20 px-1.5 py-1 text-11 font-medium text-accent-primary">
