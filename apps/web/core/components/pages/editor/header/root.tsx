...
// plane imports
import { EmojiPicker, EmojiIconPickerTypes } from "@dragonfruit/propel/emoji-icon-picker";
              ...
              <EmojiPicker
                ...
                label={
                  <button
                    type="button"
                    className={cn(
                      "flex items-center gap-1 rounded-lg p-1 text-13 font-medium text-tertiary transition-colors outline-none hover:bg-layer-1",
                      {
