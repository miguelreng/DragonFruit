...
// plane imports
import { USE_CASES } from "@dragonfruit/constants";
...
export const UseCaseSetupStep = observer(function UseCaseSetupStep({ handleStepChange }: Props) {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-10">
      {/* Header */}
      <CommonOnboardingHeader title="What brings you to DragonFruit?" description="Tell us your goals and team size." />
            ...
            <div className="flex flex-col gap-3">
              {USE_CASES.map((useCase) => {
                ...
                return (
                  ...
                  >
                    <span
                      className={cn(`flex size-4 items-center justify-center rounded-lg border-2`, {
