...
// plane ui
import { DropIndicator, ToggleSwitch } from "@dragonfruit/ui";
// plane utils
        ...
        onGenerateDragPreview: ({ nativeSetDragImage }) => {
          setCustomNativeDragPreview({
            ...
            render: ({ container }) => {
              ...
              root.render(<div className="rounded-lg bg-surface-1 p-1 pr-2 text-13">{widget.key}</div>);
              return () => root.unmount();
            },
            nativeSetDragImage,
          });
  ...
  return (
    <div className="">
      ...
      <div
        ref={elementRef}
        className={cn(
          "group/widget-item relative flex items-center justify-between rounded-lg px-2 py-2 text-13 font-medium hover:bg-layer-1",
          {
