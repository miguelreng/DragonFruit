...
export function IssueLink(props: TIssueLink) {
  ...
  return (
    <Tooltip
      tooltipContent={activity.issue_detail ? activity.issue_detail.name : "This task has been deleted"}
      isMobile={isMobile}
    >
      <a
      ...
      >
        {activity.issue_detail ? `${activity.project_detail.identifier}-${activity.issue_detail.sequence_id}` : "Tasks"}{" "}
