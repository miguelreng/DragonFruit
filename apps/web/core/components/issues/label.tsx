        ...
        labelDetails.length <= maxRender ? (
          <>
            {labelDetails.map((label) => (
              <div
                key={label.id}
                className="shadow-sm flex flex-shrink-0 cursor-default items-center rounded-lg border border-strong px-2.5 py-1 text-11"
              >
          ...
          <div className="shadow-sm flex flex-shrink-0 cursor-default items-center rounded-lg border border-strong px-2.5 py-1 text-11">
            <Tooltip
              position="top"
