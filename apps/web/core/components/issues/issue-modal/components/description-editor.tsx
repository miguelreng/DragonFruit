...
import { Sparkle } from "@/components/icons/lucide-shim";
// plane imports
  ...
  return (
    <div className="relative rounded-lg border-[0.5px] border-subtle-1 bg-layer-2">
      {descriptionHtmlData === undefined || !projectId ? (
        <Loader className="max-h-64 min-h-[120px] space-y-2 overflow-hidden rounded-lg border border-subtle p-3 py-2 pt-3">
