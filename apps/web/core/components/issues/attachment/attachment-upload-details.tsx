...
import { getFileExtension, truncateText } from "@dragonfruit/utils";
// ui
// icons
...
export const IssueAttachmentsUploadDetails = observer(function IssueAttachmentsUploadDetails(props: Props) {
  ...
  return (
    <div className="pointer-events-none flex h-[60px] items-center justify-between gap-1 rounded-lg border-[2px] border-subtle bg-surface-2 px-4 py-2 text-13">
