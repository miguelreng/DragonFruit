...
import type { TIssue, IIssueDisplayProperties, IIssueMap } from "@dragonfruit/types";
import { EIssueServiceType } from "@dragonfruit/types";
// ui
import { ControlLink, DropIndicator } from "@dragonfruit/ui";
    ...
    <>
      ...
      >
        <ControlLink
          ...
          ref={cardRef}
          className={cn(
            "block w-full rounded-xl border border-subtle bg-white px-3 pt-2 pb-3 text-13 shadow-raised-100 outline-[0.5px] outline-transparent transition-all hover:border-strong hover:shadow-raised-200",
