...
export const SpreadsheetSubIssueColumn = observer(function SpreadsheetSubIssueColumn(props: Props) {
  ...
  return (
    <Row
      ...
      className={cn(
        "flex h-9 w-full items-center border-b-[0.5px] border-subtle py-0.5 text-11 group-[.selected-issue-row]:bg-accent-primary/5 hover:bg-surface-2 group-[.selected-issue-row]:hover:bg-accent-primary",
        {
