...
// plane constants
import { EIssueFilterType, ISSUE_DISPLAY_FILTERS_BY_PAGE, PROJECT_VIEW_TRACKER_ELEMENTS } from "@dragonfruit/constants";
          ...
          <div className="relative flex h-full w-full flex-col overflow-hidden">
            ...
            <div className="relative h-full w-full overflow-auto bg-surface-1">
              ...
              {issues?.getIssueLoader() === "mutation" && (
                <div className="shadow-sm fixed top-[70px] right-[20px] z-50 flex h-[40px] w-[40px] items-center justify-center rounded-lg bg-layer-1">
