...
// plane imports
import { ARCHIVABLE_STATE_GROUPS, EUserPermissions, EUserPermissionsLevel } from "@dragonfruit/constants";
  ...
  return (
    <>
      ...
      <CustomMenu
        ...
        customButton={<IconButton size="lg" variant="secondary" icon={(props) => <Ellipsis {...props} weight="Bold" />} aria-label="Task options" />}
