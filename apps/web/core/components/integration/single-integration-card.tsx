...
import type { IAppIntegration, IWorkspaceIntegration } from "@dragonfruit/types";
// ui
...
const integrationDetails: { [key: string]: any } = {
  github: {
    ...
    notInstalled: "Connect with GitHub with your DragonFruit workspace to sync project tasks.",
  },
  slack: {
    logo: SlackLogo,
    installed: "Activate Slack on individual projects to sync with specific channels.",
    notInstalled: "Connect with Slack with your DragonFruit workspace to sync project tasks.",
  },
};
