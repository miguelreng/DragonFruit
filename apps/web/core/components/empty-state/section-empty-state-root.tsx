...
export function SectionEmptyState(props: Props) {
  ...
  return (
    <div
      className={cn(
        "flex flex-col items-center justify-center gap-4 rounded-lg border border-subtle p-10",
        customClassName
      )}
    >
      <div className="flex flex-col items-center gap-2">
        <div className="flex size-8 items-center justify-center rounded-lg bg-layer-1">{icon}</div>
