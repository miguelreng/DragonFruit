...
// DragonFruit imports
import { MODULE_STATUS, EUserPermissions, EUserPermissionsLevel, IS_FAVORITE_MENU_OPEN } from "@dragonfruit/constants";
...
import { renderFormattedPayloadDate, getDate } from "@dragonfruit/utils";
// components
...
export const ModuleListItemAction = observer(function ModuleListItemAction(props: Props) {
  ...
  return (
    <>
      <DateRangeDropdown
        buttonContainerClassName={`h-6 w-full flex ${isDisabled ? "cursor-not-allowed" : "cursor-pointer"} items-center gap-1.5 text-tertiary border-[0.5px] border-strong rounded-lg text-11`}
