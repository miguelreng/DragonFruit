...
export const AlignRight = shim(Solar.AlignRight);
export const AlignCenter = shim(Solar.AlignHorizontalCenter);
export const Bold = shim(Solar.TextBold);
export const Italic = shim(Solar.TextItalic);
export const Strikethrough = shim(Solar.TextCross);
export const DollarSign = shim(Solar.Dollar);
export const PaintBucket = shim(Solar.PaintRoller);
...
export const MapPin = shim(Solar.MapPoint);
...
export const Moon = shim(Solar.Moon);
...
export const Sun = shim(Solar.Sun);
...
export const Video = shim(Solar.Videocamera);
