...
export function ComingSoonBadge({ className }: { className?: string }) {
  return (
    <span
      className={cn(
        "w-fit rounded-lg bg-accent-primary px-1.5 py-0.5 text-9 font-semibold whitespace-nowrap text-on-color",
        className
      )}
    >
      COMING SOON
...
export const PLANS_COMPARISON_LIST: TPlansComparisonDetails[] = [
    ...
    features: [
      {
        ...
        description:
          "Track progress in cycles, modules, and overviews\nthroughout DragonFruit without switching to dashboards\nor Analytics.",
        cloud: {
          free: false,
          one: false,
          pro: true,
  ...
  },
  {
    ...
    features: [
      ...
      // },
      {
        title: "PQL",
        description:
          "Write DragonFruit Query Language in search with support\nfor Boolean operators. Soon, you can write natural\nlanguage queries.",
        cloud: {
          free: false,
          one: false,
          pro: true,
    ...
    features: [
      {
        title: "GitHub",
        description:
          "Sync DragonFruit tasks and states to GitHub tasks and\nstates. Update GitHub automatically with activity\nfrom DragonFruit and vice-versa.",
        cloud: {
          free: false,
          one: false,
          pro: true,
      ...
      {
        title: "Slack",
        description: "Get DragonFruit activity in Slack and use / commands in\nSlack to make changes in DragonFruit.",
        cloud: {
          free: false,
          one: false,
          pro: true,
      ...
      {
        title: "Zendesk",
        description: "Create DragonFruit tasks from Zendesk tickets.",
        cloud: {
          free: false,
          one: false,
          pro: true,
      ...
      {
        title: "Freshdesk",
        description: "Create DragonFruit tasks from Freshdesk tickets.",
        cloud: {
          free: false,
          one: false,
          pro: true,
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "Choose other domains that can authenticate into\nyour DragonFruit workspace or restrict all but one domain.",
        cloud: {
          free: false,
          one: false,
          pro: true,
  ...
  },
  {
    ...
    features: [
      {
        title: "God Mode",
        description: "Manage your self-hosted DragonFruit instance better with\nan instance admin interface.",
        cloud: {
          free: true,
          one: true,
          pro: true,
