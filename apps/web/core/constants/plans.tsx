...
export const PLANS_COMPARISON_LIST: TPlansComparisonDetails[] = [
  ...
  },
  {
    ...
    features: [
      ...
      {
        title: "Zendesk",
        description: "Create DragonFruit work items from Zendesk tickets.",
        cloud: {
          free: false,
          one: false,
          pro: true,
      ...
      {
        title: "Freshdesk",
        description: "Create DragonFruit work items from Freshdesk tickets.",
        cloud: {
          free: false,
          one: false,
          pro: true,
